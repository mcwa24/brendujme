...
const inputGroupAddonVariants = cva(
  "flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[var(--radius)] [&>svg:not([class*='size-'])]:size-4",
  {
    variants: {
      align: {
        "inline-start":
  ...
  "flex items-center gap-2 text-sm shadow-none",
  {
    variants: {
      size: {
        ...
        sm: "",
        "icon-xs":
          "size-6 rounded-[var(--radius)] p-0 has-[>svg]:p-0",
